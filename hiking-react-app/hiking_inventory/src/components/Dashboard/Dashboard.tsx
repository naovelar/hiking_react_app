...
import HikingIcon from '@material-ui/icons/Tv';
        ...
        <div className={classes.root}>
            ...
            <AppBar position="fixed" style= {{background: '#b39ddb'}} className={clsx(classes.appBar, {[classes.appBarShift]: open})}>
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Trail Review</Button>
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                      <DialogTitle id="form-dialog-title">Add New Trail Review</DialogTitle>
                      <DialogContent>
                        <DialogContentText>Add A New Trail Review</DialogContentText>
                          <ReviewForm />
                      </DialogContent>
                      <DialogActions>
